...
class GameUI:
    def __init__(self, screen):
        ...
        self.__bg_image = GameUtils.load_image(
            "image/bg_table2.jpg", Config.screen_size[1], Config.screen_size[0]
        )
    ...
    def render(self):
        ...
        self.__dealer.render(
            x=526, y=59, is_dealer=True, is_end_phase=(self.__phase == GamePhase.END)
        )
